    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.Property(e => e.PhoneNumber).HasColumnName("phone_number").HasMaxLength(50).IsRequired();
                ...
                entity.Property(e => e.LoanType).HasColumnName("loan_type").HasMaxLength(50).HasDefaultValue("Consumer Loans");
            ...
            modelBuilder.Entity<Transaction>(entity =>
            {
                ...
                entity.Property(e => e.PinAttempts).HasColumnName("pin_attempts").HasDefaultValue(0);
                entity.Property(e => e.ErrorMessage).HasColumnName("error_message");
                entity.Property(e => e.FailureReason).HasColumnName("failure_reason").HasMaxLength(50);
                entity.Property(e => e.StkPushSentAt).HasColumnName("stk_push_sent_at");
            ...
            modelBuilder.Entity<Promise>(entity =>
            {
                ...
                entity.Property(e => e.FollowUpCount).HasColumnName("follow_up_count").HasDefaultValue(0);
                entity.Property(e => e.CreatedAt).HasColumnName("created_at").HasColumnType("datetime").HasDefaultValueSql("CURRENT_TIMESTAMP");
                entity.Property(e => e.UpdatedAt).HasColumnName("updated_at").HasColumnType("datetime").HasDefaultValueSql("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP");
            ...
            modelBuilder.Entity<Activity>(entity =>
            {
                ...
                entity.Property(e => e.Status).HasColumnName("status").HasMaxLength(50).HasDefaultValue("SUCCESS");
                entity.Property(e => e.ErrorMessage).HasColumnName("error_message");
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                entity.Property(e => e.Id).HasColumnName("id").ValueGeneratedOnAdd();
                entity.Property(e => e.CustomerId).HasColumnName("customer_id").IsRequired();
                entity.Property(e => e.UserId).HasColumnName("author_id");
                entity.Property(e => e.CommentText).HasColumnName("comment_text").IsRequired();
                entity.Property(e => e.CommentType).HasColumnName("comment_type").HasMaxLength(50).HasDefaultValue("follow_up");
